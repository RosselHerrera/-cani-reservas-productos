...
$uvodka20 = $_POST['uvodka20'];
$uvodka12 = $_POST['uvodka12'];
$ubrandy12 = $_POST['ubrandy12'];
$subject = $_POST['observacion'];
$email = $_POST['email'];
$condicion = $_POST['condicion'];
$datepicker = $_POST['datepicker'];

$sql = "SELECT ID, CLICI, CLINOMBRE, CLIAPELLIDOS, CLIEMAIL, FECHAVIGENCIA, FECHAREGISTRO, CATEGORIA, FILLER FROM `clientes` WHERE CLIEMAIL = '$email' ";
...
if (mysqli_num_rows($result) > 0) {
	...
	while($row = mysqli_fetch_assoc($result)) {
		...
		echo "BIENVENIDO : " . $CLINOMBRE . " " . $CLIAPELLIDOS;
		echo "¿en que te podemos atender? : "
	} 	
 } else {	 
	header("Location: https://pucondistillery.cl/index.html#contact");
	exit();
 }	
