...
$sql = "SELECT ID, NOMBRE, EMAIL, MENSAJE FROM `visita`";
$result = mysqli_query($conn, $sql);

if (mysqli_num_rows($result) > 0) {
  // output data of each row
  echo  "<br><br>";
  echo  "<B><H4>VISITANTES DE LA PAGINA QUE DEJAN MENSAJE</H4></B>";
  echo  "<br><br>";
  while($row = mysqli_fetch_assoc($result)) {
  echo "<b>ID:</b> " . $row["ID"]. " <b>- Nombre: </b>" . $row["NOMBRE"]. "  <b>- Email: </b>" . $row["EMAIL"] . "  <b>- Mensaje: </b>" . $row["MENSAJE"] . "<br><br>";
  }
echo  "<br><br><br>";  
} else {
  echo "0 results";
				...
				<div class="row">
					<div class="col-lg-5 col-md-6 col-sm-6">
						<div class="single-footer-widget">
							<h6>Somos</h6>
							<p>
								Profesionales de la comunicación visual y las Tecnologías de la Informaci&oacute;n.
							</p>
